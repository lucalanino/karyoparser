...
- `truncate_str()`, `empty_issues_tibble()`, `strip_bands()`, `normalize_token()`, `.extract_df_input()`, `.confirm_column()`, `.abort_column_selection()` (in `R/helpers.R`)
